...
worldinfoStart='<tr class="total_row_world row_continent" data-continent="North America"'
worldinfoEnd='<td style="display:none" data-continent="all">All</td>'
...
tail -n +2 $wFile > $wFile2

# i=0
# declare -a dataFields=( "total" "newActive" "deaths" "newDeaths" "recovered" "newRecovered" "active" "critical" "casesPM" "deathsPM" "name")
